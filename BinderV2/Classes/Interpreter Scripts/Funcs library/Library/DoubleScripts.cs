...
namespace InterpreterScripts.Funcslibrary.Library
{
    ...
    {
        [FuncDescription("SumDouble(double n1, double n2...) - возвращает результат сложения всех переданных аргументов.")]
        ...
        [FuncDescription("MinusDouble(double num, double n1...) - возвращает результат вычитания всех чисел начиная с n1 из num.")]
        ...
        [FuncDescription("MultyplyDouble(double num1, double num2) - возвращает результат умножения чисел num1 и num2.")]
        ...
        [FuncDescription("DivDouble(double num1, double num2) - возвращает результат деления чисела num1 на num2.")]
        ...
        [FuncDescription("ConvertStringToDouble(string str) - пытается конвернитровать string в double.")]
