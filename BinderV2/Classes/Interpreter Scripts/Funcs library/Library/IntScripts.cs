...
namespace InterpreterScripts.Funcslibrary.Library
{
    ...
    {
        [FuncDescription("SumInt(int n1, int n2...) - возвращает результат сложения всех переданных аргументов.")]
        ...
        [FuncDescription("MinusInt(int num, int n1...) - возвращает результат вычитания всех чисел начиная с n1 из num.")]
        ...
        [FuncDescription("MultyplyInt(int num1, int num2) - возвращает результат умножения чисел num1 и num2.")]
        ...
        [FuncDescription("DivInt(int num1, int num2) - возвращает результат деления чисела num1 на num2.")]
        ...
        [FuncDescription("ConvertFromStringToInt(string str) - пытается конвернитровать string в int.")]
        ...
        [FuncDescription("Compare(object l, object r) - производит компарирование со значениями l и r.")]
        ...
        [FuncDescription("GetProcessID(string name) - возвращает ID процесса с именем name. Если процесс не найден вернёт -1.")]
        ...
        [FuncDescription("GetProcessIDForgedWindow() - возвращает ID процесса активного окна.")]
        ...
        [FuncDescription("GetCursorPosX() - возвращает позицию курсора по координате X.")]
        public static int GetCursorPosX(params object[] ps)
        {
            return Cursor.Position.X;
        }

        [FuncDescription("GetCursorPosY() - возвращает позицию курсора по координате Y.")]
