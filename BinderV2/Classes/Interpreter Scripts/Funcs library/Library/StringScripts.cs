...
namespace InterpreterScripts.Funcslibrary.Library
{
    ...
    {
        [FuncDescription("ToString(object o1, object o2...) - возвращает строковое представление объекта(ов)(можно использовать для объединения строк).")]
        ...
        [FuncDescription("GetDesktopPath() - возвращает путь до рабочего стола.")]
        public static string GetDesktopPath(params object[] ps)
        {
            return Environment.GetFolderPath(Environment.SpecialFolder.Desktop);
        }

        [FuncDescription("ReplaceString(string str, string subStr, string replace) - возвращает строку с заменёнными subStr на replace.")]
        ...
        [FuncDescription("GetUserName() - возвращает имя текущего пользователя.")]
        ...
        [FuncDescription("GetKeysHelp() - возвращает помощь по кнопкам.")]
        ...
        [FuncDescription("GetSendKeysHelp() - возвращает помощь для скрипта SendKeysWait.")]
        ...
        [FuncDescription("GetMouseEventsHelp() - возвращает помощь для скрипта MouseEvent.")]
        ...
        [FuncDescription("GetClipboardText() - возвращает текст из буфера обмена Windows.")]
        ...
        [FuncDescription("LayoutSimbols(string text) - возвращает текст с изменённой раскладкой русский-английский по QWERTY.")]
