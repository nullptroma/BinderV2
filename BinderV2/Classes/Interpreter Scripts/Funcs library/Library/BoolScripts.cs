...
namespace InterpreterScripts.Funcslibrary.Library
{
    ...
    {
        [FuncDescription("HideDesktopBackground() - скрывает фон рабочего стола. Возвращает результат операции.")]
        ...
        [FuncDescription("ShowDesktopBackground() - показывает фон рабочего стола. Возвращает результат операции.")]
        ...
        [FuncDescription("MoreThan(object left, object right) - сравнивает 2 значения и возвращает true если left>right.")]
        ...
        [FuncDescription("LessThan(object left, object right) - сравнивает 2 значения и возвращает true если left<right.")]
        ...
        [FuncDescription("Equal(object left, object right) - сравнивает 2 значения и возвращает true если left==right.")]
        ...
        [FuncDescription("And(bool b1, bool b2....) - применяет операцию AND ко все параметрам и возвращает результат.")]
        ...
        [FuncDescription("Or(bool b1, bool b2....) - применяет операцию OR ко все параметрам и возвращает результат.")]
        ...
        [FuncDescription("Not(bool b) - возвращает инвертированное значение b.")]
